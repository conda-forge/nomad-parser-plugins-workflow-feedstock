About nomad-parser-plugins-workflow-feedstock
=============================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-parser-plugins-workflow-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-parser-plugins-workflow-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-parser-plugins-workflow
# for installing globally
pixi global install nomad-parser-plugins-workflow
```
...
It is possible to list all of the versions of `nomad-parser-plugins-workflow` available on your platform:
...
```
pixi search nomad-parser-plugins-workflow --channel conda-forge
```
